...
public class EHCContext {
    ...
    public void setEHCContext(Heuristic.Type heuristic, double weight, double timeout){
        this.heuristic = heuristic;
        this.weight = weight;
        this.timeout = timeout;
    }

    public boolean resolveWithEHC(Token token) throws IOException {
        if (token.isRunnable()) {
